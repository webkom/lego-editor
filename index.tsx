...
function insertTab(options?: object) {
  return {
...
function softEnter(types: Array<string>) {
  return {
    onKeyDown(
      event: React.KeyboardEvent,
      editor: slateTypes.EditorProperties,
      next: () => void
    ) {
...
export default class Editor extends React.Component<Props, State> {
  ...
  toggleBlock = (e: React.SyntheticEvent<any>, type: string) => {
    e.preventDefault();
  ...
  onKeyDown = (e: React.KeyboardEvent, editor: slateTypes.Editor, next) => {
